...
templateFile = thisfolder.split(
    sep, 1)[0] + "/doc/templates/review-template.html"
print("Path to template file :\t " + templateFile)


template = Template(filename=templateFile, default_filters=[
                    'decode.utf8'], input_encoding='utf-8', output_encoding='utf-8', encoding_errors='replace')
